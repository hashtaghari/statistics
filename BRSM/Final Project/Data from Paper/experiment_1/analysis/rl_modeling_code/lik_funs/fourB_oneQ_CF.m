...
function [loglik] = fourB_oneQ_CF(parameters, subj)
...
nd_alpha_choice = parameters(5); % normally distributed alpha
alpha_choice = 1/(1+exp(-nd_alpha_choice)); % alpha (transformed to be between zero and one)
