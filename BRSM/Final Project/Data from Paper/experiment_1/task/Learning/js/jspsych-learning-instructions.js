   ...
   // console.log(trial.audio_stim)
    ...
    function show_button() {
      ...
      for (var i = 0; i < trial.choices.length; i++) {
        ...
        html += '<div class="learning-instructions-button" style=" margin:' + trial.margin_vertical + ' ' + trial.margin_horizontal + '" id="learning-instructions-button-' + i + '" data-choice="' + i + '">' + str + '</div>';
      }
      html += '</div>';
      display_element.innerHTML = html;
      ...
      for (var i = 0; i < trial.choices.length; i++) {
        display_element.querySelector('#learning-instructions-button-' + i).addEventListener('click', function (e) {
